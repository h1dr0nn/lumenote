...
**App name:** Lumenote  
**Tagline:** *Clear notes. Calm thinking.*
...
- [ ] Table: notes
- [ ] Table: folders
- [ ] CRUD API (notes, folders)
- [ ] updated_at / created_at

#### Frontend
- [ ] Load notes từ backend
- [ ] Save note content
- [ ] Sidebar render từ DB
...
### Done criteria
- Restart app không mất note
- DB chỉ lưu markdown + metadata
- Có thể rebuild UI hoàn toàn từ DB
